...
function getWorkingData() {
  const currentDiskVersion = (typeof PORTFOLIO_DATA !== 'undefined' && PORTFOLIO_DATA.dataVersion) ? PORTFOLIO_DATA.dataVersion : '20260915_v50_raeng_highlight_in_about_card';
...
/**
 * Commit PORTFOLIO_DATA directly to GitHub repository via REST API
 * Fully handles SHA mismatch conflicts with automatic re-sync and retry
 */
